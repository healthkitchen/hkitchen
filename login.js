...
function validate(){
    ...
    if(!username){
        ...
        localStorage.setItem("save1",profile.save1);
        localStorage.setItem("save2",profile.save2);
...
var profiles = {
    "GRamsay":{
        ...
        save1:"[40,65,65,70,91,102,130]",
        save2:"[60,89,89,130,170,190,230]",
    },
    "JAverage":{
        firstname:"Joe",
        password:"average2",
        ...
        save1:"[20,40,60,80,90,110,120]",
        save2:"[35,65,95,115,150,200,210]",
    }
};